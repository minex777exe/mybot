...
class MentionDropdown(discord.ui.Select):
    def __init__(self, message: discord.Message, bot: commands.Bot, prefix: str):
        ...
        super().__init__(placeholder="Start With Fire X", min_values=1, max_values=1, options=options)
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if self.values[0] == "Home":
            ...
            embed.description = (
                ...
                "**The Founder**\n"
                "**[01]. [Ankit](https://discord.com/users/1090081155669311488)**\n**[01]. [Kaelz](https://discord.com/users/1388389895889879171)**"
            )
        elif self.values[0] == "Links":
            embed.title = "<:zyroxlinks:1448949436939239495> Important Links"
            embed.description = (
                "**[Invite Fire X](https://discord.com/oauth2/authorize?client_id=1405824054660825279&permissions=8&integration_type=0&scope=bot+applications.commands)**\n"
                "**[Join Support Server](https://discord.gg/z59udf5fC7)**"
            )

        embed.set_footer(text="Powered by FrostFire Development™", icon_url=self.bot.user.avatar.url)
